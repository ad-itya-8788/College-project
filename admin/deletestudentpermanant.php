...
$select_sql = "SELECT sname, course_name, enrollment, semester FROM student WHERE enrollment='$enrollment'";
...
<div class="container">
    ...
    if ($student_info)
        ...
        echo "</div>";
        $delete_sql = "DELETE FROM student WHERE enrollment='$enrollment'";
