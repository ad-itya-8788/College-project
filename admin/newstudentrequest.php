...
?>
<!DOCTYPE html>
<!--This file is display if any new studnt is register or not and  manage approve it or delte it-->
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <select name="academic_year" id="academic_year">
                    ...
                    <option value="2026-202">2026-2027</option>
                </select>
            </div>
...
$srno = 0;
    ...
    $sql = "SELECT * FROM tempstudent WHERE 1=1";
...
echo "<tr>
        ...
        <th>Fee Receipt</th>
        <th>Manage</th> <!-- Column for Approve/Delete buttons -->
      </tr>";
echo "</thead>";
echo "<tbody>";
...
echo "<td>
 <button style='margin: 4px; background-color: green;' onclick='approveStudent(\"{$row['enrollment']}\")'>Approve</button>
...
?>
<script>
    function approveStudent(enrollment)
     {
        if (confirm("Are you sure you want to approve this student?")) 
        {
            window.location.href = 'approve_student.php?enrollment=' + enrollment;
        }
    }
    ...
    function deleteStudent(enrollment) {
        ...
        {
            window.location.href = 'deltempstudent.php?enrollment=' + enrollment;
        }
    }
</script>
</div>
